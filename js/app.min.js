...
$( ".confirm-create" ).click(function(){ 
    $('<div class=adv-item><div class=adv-picture-block><img alt=""src=""></div><div class=text-adv-container><div class=adv-title-block><p class=title-par></div><div class=adv-text-block><p class=text-par></div></div><div class=adv-price-tag><div class=adv-price><p class=price-par>₽</div><div class=adv-buy-container><div class=adv-buy><p>Купить</div><div class=adv-favourites></div></div></div></div>').appendTo('.adv-block__container');
    var titleText = $('#input-title');
    $('titleText').appendTo('.title-par');
    var texTarea = $('#input-text');
    $('titleText').appendTo('.text-par');
    var priceText = $('#input-price');
    $('titleText').appendTo('.price-par'); 
});
